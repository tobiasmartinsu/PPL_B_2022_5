...
<nav class="header-nav ms-auto">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="progress_mahasiswa_khs_dosen.php">
          <i class="bi bi-layout-text-window-reverse"></i>
          <span>Progress Mahasiswa KHS</span>
        </a>
        <li class="nav-item">
        <a class="nav-link  " href="progress_mahasiswa_skripsi_dosen.php">
          <i class="bi bi-layout-text-window-reverse"></i>
  ...
  <main id="main" class="main">
         ...
         <div class="col-12">
                <div class="card recent-sales overflow-auto">
                  <div class="card-body">
                    <h5 class="card-title">Progress Mahasiswa Skripsi</h5>
                    <table class="table table-borderless datatable">
                      ...
                      <tbody>
                      <?php
                          $query = "SELECT * FROM data_skripsi";
