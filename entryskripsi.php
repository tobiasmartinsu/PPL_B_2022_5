                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Lama Studi (dalam semester)</th>
                        <th scope="col">tanggal sidang (dd/mm/yyyy)</th>
                      ...
                      <tr>
                        ...
                        <?php
                        $query = "SELECT * FROM data_skripsi WHERE nim = '" . $nim . "'";
                        $result = $koneksi->query($query);
                        ...
                        while ($row = $result->fetch_object()) {
                          ...
                          echo '<td><a href="editskripsi.php?semester=' . $row->semester . '">Edit</a> | <a class="btn btn-danger btn-sm" href="deleteskripsi.php?id=' . $row->semester . '">Delete</a></td>';
                          echo '</tr>';
                        }
                        echo '</table>';
                        echo '<br />';
