                ...
                <div class="card recent-sales overflow-auto">
                  ...
                  <div class="card-body">
                    ...
                    <div class="main-content card">
                      <div class="card-header h3">Entry PKL</div>
                      <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label class="form-label" for="">Status (LULUS/BELUM)</label><br>
                            <input class="form-control" name="status_pkl">
                          </div>
                          <div class="form-group">
                            <label class="form-label" for="">Nilai</label><br>
                            <input class="form-control" name="nilai_pkl">
                          </div>
                          </br>
                          <div class="form-group">
                            <label class="form-label" for="">Dosen Pembimbing</label><br>
                            <input class="form-control" name="dosen_pembimbing">
                          </div>
                          </br>
                          <div class="form-group">
