...
if (!isset($_POST['submit'])) {
    $query = "SELECT * FROM data_skripsi WHERE semester = '" . $semester . "' AND nim ='" . $nim . "' ";
    $result = $koneksi->query($query);
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
    ...
    $query = "UPDATE data_skripsi SET semester='" . $semester . "', status_skripsi = '" . $status_skripsi . "', nilai_skripsi = '" . $nilai_skripsi . "', lama_studi = '" . $lama_studi . "' , tanggal_sidang = '" . $tanggal_sidang . "', upload_file = '" . $upload_file . "' WHERE semester = '" . $semester . "' AND nim='" . $nim . "'";
    $result = $koneksi->query($query);
    if (!$result) {
                                ...
                                <div class="card recent-sales overflow-auto">
                                    <div class="card-body">
                                        ...
                                        <div class="main-content card">
                                            <div class="card-header h3">Edit Skripsi</div>
                                            <div class="card-body">
                                                <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?nim=' . $nim; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="status_skripsi" value="<?php if (isset($status_skripsi)) {
                                                                                                                        echo $status_skripsi;
                                                                                                                    } ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label" for="">Nilai</label><br>
                                                        <input class="form-control" name="nilai_skripsi" value="<?php if (isset($nilai_skripsi)) {
                                                                                                                    echo $nilai_skripsi;
                                                                                                                }  ?>">
                                                    </div>
                                                    </br>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="lama_studi" value="<?php if (isset($lama_studi)) {
                                                                                                                    echo $lama_studi;
                                                                                                                }  ?>">
                                                    </div>
                                                    </br>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="tanggal_sidang" value="<?php if (isset($tanggal_sidang)) {
                                                                                                                        echo $tanggal_sidang;
                                                                                                                    }  ?>">
                                                    </div>
                                                    </br>
