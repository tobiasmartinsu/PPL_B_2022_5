...
if (!isset($_POST['submit'])) {
    $query = "SELECT * FROM data_khs WHERE semester = '" . $semester . "' AND nim ='" . $nim . "' ";
    $result = $koneksi->query($query);
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
    ...
    $query = "UPDATE data_khs SET semester ='" . $semester . "', sks_semester ='" . $sks_semester . "', sks_kumulatif ='" . $sks_kumulatif . "', ip_semester = '" . $ip_semester . "', ip_kumulatif = '" . $ip_kumulatif . "', upload_file='" . $upload_file . "' WHERE semester = '" . $semester . "' AND nim='" . $nim . "'";
    $result = $koneksi->query($query);
    if (!$result) {
                                ...
                                <div class="card recent-sales overflow-auto">
                                    <div class="card-body">
                                        ...
                                        <div class="main-content card">
                                            <div class="card-header h3">Edit KHS</div>
                                            <div class="card-body">
                                                <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?nim=' . $nim; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="ip_semester" value="<?php if (isset($ip_semester)) {
                                                                                                                    echo $ip_semester;
                                                                                                                }  ?>">
                                                    </div>
                                                    </br>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="ip_kumulatif" value="<?php if (isset($ip_kumulatif)) {
                                                                                                                    echo $ip_kumulatif;
                                                                                                                }  ?>">
                                                    </div>
                                                    </br>
