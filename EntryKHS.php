                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      ...
                      <tr>
                        <!-- show data from db  -->
                        <?php
                        $query = "SELECT * FROM data_khs WHERE nim = '" . $nim . "'";
                        $result = $koneksi->query($query);
                        ...
                        while ($row = $result->fetch_object()) {
                          ...
                          echo '<td><a href="editKHS.php?semester=' . $row->semester . '">Edit</a> | <a class="btn btn-danger btn-sm" href="deleteKHS.php?id=' . $row->semester . '">Delete</a></td>';
                          echo '</tr>';
                        }
                        echo '</table>';
                        echo '<br />';
