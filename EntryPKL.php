                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      ...
                      <tr>
                        ...
                        <?php
                        $query = "SELECT * FROM data_pkl WHERE nim = '" . $nim . "'";
                        $result = $koneksi->query($query);
                        ...
                        while ($row = $result->fetch_object()) {
                          ...
                          echo '<td><a href="editPKL.php?semester=' . $row->semester . '">Edit</a> | <a class="btn btn-danger btn-sm" href="deletePKL.php?id=' . $row->semester . '">Delete</a></td>';
                          echo '</tr>';
                        }
                        echo '</table>';
                        echo '<br />';
